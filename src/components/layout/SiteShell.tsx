 ...
 * pill has a single size, so the clearance is one figure rather than a range:
 *
 *  - the pill is `p-8px` around 44px minimum touch targets — the 28px logo sits
 *    well inside them — so 44 + 2×8 = **60px** tall, inset 12px below
