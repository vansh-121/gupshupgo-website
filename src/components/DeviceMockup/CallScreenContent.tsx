    ...
    <div className="flex h-full w-full flex-col justify-between bg-brand-dark px-4 pb-5 pt-12">
      ...
      <div className="flex flex-col items-center gap-2">
        <span className="inline-flex items-center gap-1.5 rounded-pill bg-white/10 px-2.5 py-1">
          ...
          <span className="text-caption font-medium text-white/85">
      ...
      <div className="flex flex-col items-center gap-3">
        <span className="flex h-20 w-20 items-center justify-center rounded-pill bg-white/15 text-h3 font-semibold text-white">
          {initials}
        </span>
        <div className="text-center">
          <p className="text-body-lg font-semibold text-white">{screen.callerName}</p>
          <p className="mt-0.5 text-caption text-white/70">{screen.statusLabel}</p>
          <p className="mt-1 text-body-sm font-medium tabular-nums text-white/85">
